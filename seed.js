...
User.remove({})
  ...
  .then(function(){
      return User.create([
          ...
          {name:'Erik Gomez', email:'ego.xiv@gmail.com',github:'https://github.com/egoxiv', role:'student', avatar: 'http://images.shibashake.com/wp-content/blogs.dir/7/files/2012/03/375757_10150889470687524_800937523_12981704_1473609087_n-520x346.jpg', 'application.status': 'enrolled'},
        ]);
  })
  .then(function(users){
