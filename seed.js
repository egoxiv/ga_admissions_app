...
<<<<<<< HEAD
  ...
  .then(function(){
    return User.create([
      ...
      {name:'Erik Gomez', email:'ego.xiv@gmail.com', github:'https://github.com/egoxiv', role:'student', application: { status: 'evaluated' } }
    ]);
  })
  .then(function(users){
...
=======
  ...
  .then(function(users){
      ...
      return cohort.save();
>>>>>>> 1c7cec5cd3aa4f1dddae9387993eae719aad1957
  })
  .catch(function(err){
    console.log(err);
    return err;
