...
User.remove({})
	.then(function(){
 	...
 	.then(function(){
      ...
      {name:'Matt Parvinsmith', email:'mrparvinsmith@gmail.com', ga_email:'mrparvinsmith@gmail.com',github:'https://github.com/mrparvinsmith', role: 'admissions' },
      {name:'Erik Gomez', email:'ego.xiv@gmail.com', ga_email:'ego.xiv@gmail.com',github:'https://github.com/egoxiv', github_username: 'egoxiv', role:'student', 'application.status': 'accepted' },
      ...
      {name:'Evan Washington', email:'enavy04@gmail.com', ga_email:'enavy04@gmail.com',github:'https://github.com/Navyvet1125', role:'student', 'application.status': 'accepted' },
  ...
  .then(function(users){
    ...
    users.forEach(function(user){
      ...
      } else if (user.role==='student' && user.application.status === 'enrolled') {
        user.instructor = cohort.instructors[cohort.instructors.length-1];
        user.cohort = cohort._id;
        user.save();
